...
const InsertionSortExplanation = () => {
    ...
    const applications = [
        { title: 'Small Data Sorting', description: 'Efficiently sorts small datasets where simplicity is key.', icon: <FiTarget size={20} className="text-pink-400" /> },
        { title: 'Online Sorting', description: 'Handles data arriving incrementally in real-time systems.', icon: <BsGraphUp size={20} className="text-blue-400" /> },
        { title: 'Nearly Sorted Arrays', description: 'Excels with nearly sorted data due to its adaptive nature.', icon: <FiLayers size={20} className="text-purple-400" /> },
        { title: 'Stable Sorting', description: 'Preserves order of equal elements in sorted output.', icon: <FiCpu size={20} className="text-green-400" /> },
    ];

    // Learning resources
    const resources = [
        { title: 'Interactive Insertion Sort Visualization', url: 'https://www.example.com/insertion-sort-visualization', description: 'See Insertion Sort in action with step-by-step visualization' },
        { title: 'Insertion Sort Interview Questions', url: 'https://www.example.com/insertion-sort-questions', description: 'Practice with common interview problems' },
        { title: 'Insertion Sort vs Other Algorithms', url: 'https://www.example.com/insertion-vs-others', description: 'Compare Insertion Sort with Bubble Sort, Selection Sort, etc.' },
    ];
                ...
                >
                    ...
                    >
                        <p className="text-gray-200 text-lg md:text-xl leading-relaxed text-center max-w-3xl mx-auto font-light">
                            Insertion Sort builds the sorted array <span className="text-purple-300 font-semibold">one item at a time</span> by inserting each element into its correct position within the sorted portion.
                        </p>
                        ...
                        <AnimatePresence>
                            {isHovered && (
                                ...
                                >
                                    ...
                                    Insertion Sort is highly efficient for small or nearly sorted datasets
                                </motion.div>
                            )}
                        </AnimatePresence>
                    </motion.div>
                            ...
                            >
                                ...
                                >
                                    ...
                                    <ul className="space-y-5">
                                        {[
                                            { icon: <FiClock size={20} />, label: 'Time Complexity', value: 'O(n²) / O(n)', color: 'text-purple-400' },
