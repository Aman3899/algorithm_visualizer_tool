...
const BubbleSortExplanation = () => {
    ...
    const applications = [
        { title: 'Small Data Sorting', description: 'Efficiently sorts small lists where simplicity is preferred over speed.', icon: <FiTarget size={20} className="text-pink-400" /> },
        ...
        { title: 'Nearly Sorted Arrays', description: 'Performs well on nearly sorted data due to its adaptive nature.', icon: <FiLayers size={20} className="text-purple-400" /> },
    ...
    // Learning resources
    const resources = [
        { title: 'Interactive Bubble Sort Visualization', url: 'https://www.example.com/bubble-sort-visualization', description: 'See Bubble Sort in action with step-by-step visualization' },
        { title: 'Bubble Sort Interview Questions', url: 'https://www.example.com/bubble-sort-questions', description: 'Practice with common interview problems' },
        { title: 'Bubble Sort vs Other Algorithms', url: 'https://www.example.com/bubble-vs-others', description: 'Compare Bubble Sort with Selection Sort, Insertion Sort, etc.' },
    ];
                ...
                >
                    ...
                    >
                        <p className="text-gray-200 text-lg md:text-xl leading-relaxed text-center max-w-3xl mx-auto font-light">
                            Bubble Sort iteratively compares and swaps <span className="text-purple-300 font-semibold">adjacent elements</span>, pushing larger values to the end in each pass until the array is fully sorted.
                        </p>
                        ...
                        <AnimatePresence>
                            {isHovered && (
                                ...
                                >
                                    ...
                                    Bubble Sort is adaptive, stopping early if the array is already sorted
                                </motion.div>
                            )}
                        </AnimatePresence>
                    </motion.div>
