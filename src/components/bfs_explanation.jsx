    ...
    return (
        ...
        >
            ...
            <p className="text-gray-200 mb-6 text-lg leading-relaxed text-center max-w-3xl mx-auto font-light">
                BFS explores a graph <span className="text-purple-300 font-semibold">level by level</span>, systematically visiting all neighbors of a node before moving deeper. It relies on a <span className="text-indigo-300 font-semibold">queue</span> to maintain this orderly traversal.
            </p>
                ...
                <div className="bg-gray-900/50 p-6 rounded-2xl shadow-inner border border-purple-500/30">
                    ...
                    <ul className="text-gray-200 list-none space-y-3">
                        {[
                            ...
                            { label: 'Traversal', value: 'Level-order exploration', color: 'text-purple-400' },
                            { label: 'Best Use', value: 'Shortest path in unweighted graphs', color: 'text-purple-400' },
                        ].map((item, idx) => (
                    ...
                    <div className="relative">
                        <pre className="bg-gray-800/90 p-5 rounded-xl text-sm text-gray-200 font-mono leading-relaxed shadow-lg border border-purple-600/30 overflow-x-auto">
                            <code className="block text-purple-200">
                                ...
                                <span className="ml-4 text-indigo-300">queue = [start]</span>{'\n'}
                                <span className="ml-4 text-blue-300">while queue is not empty:</span>{'\n'}
                                <span className="ml-8 text-yellow-300">node = queue.dequeue()</span>{'\n'}
                                ...
                                <span className="ml-20 text-green-300">queue.enqueue(neighbor)</span>
                            </code>
                        </pre>
                        {/* Button Container */}
